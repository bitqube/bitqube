...
find ${DISTNAME}/bin -type f -executable -exec ../bitqube/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../bitqube/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/bitqube/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/bitqube/depends/SDKs/MacOSX10.11.sdk.tar.gz
