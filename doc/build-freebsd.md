Build instructions for BitQube 
=================================
FreeBSD 13.0
---------------------------------
...
You can now start bitqube-qt from the build directory.

`src/qt/bitqube-qt`

bitqubed and bitqube-cli are in `src/`
