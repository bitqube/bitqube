...
Below are some notes on how to build BitQube Core for Windows.
...
way. This will install to `c:\workspace\bitqube`, for example:

    make install DESTDIR=/mnt/c/workspace/bitqube
