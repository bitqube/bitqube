...
By default, bitqube-core allows up to 125 connections to different peers, 12 of
...
limits are tiny. Keep in mind that bitqube's trustless model works best if you are
