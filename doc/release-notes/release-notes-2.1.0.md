BitQube Core version *2.1.0* is now available!!
==============

  <https://github.com/BitQubeProject/BitQube/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/BitQubeProject/BitQube/commits/release_2.1.0>
