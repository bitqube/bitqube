BitQube Core version *2.2.2* is now available!!
==============

  <https://github.com/BitQubeProject/BitQube/releases/tag/v2.2.2>
...
- Enhancements for BitQube Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/BitQubeProject/BitQube/commits/release_2.2.2>
