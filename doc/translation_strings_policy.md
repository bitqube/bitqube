...
This document provides guidelines for internationalization of the BitQube Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitqube_en.ts` remains unchanged.
