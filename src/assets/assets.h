...
#ifndef BITQUBE_ASSET_PROTOCOL_H
#define BITQUBE_ASSET_PROTOCOL_H
...
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_BITQUBE_ASSET BTQO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_BITQUBE_ASSET BTQR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_BITQUBE_ASSET BTQT
...
#endif //BITQUBE_ASSET_PROTOCOL_H
