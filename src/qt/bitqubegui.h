...
#ifndef BITQUBE_QT_BITQUBEGUI_H
#define BITQUBE_QT_BITQUBEGUI_H
...
/**
  BitQube GUI main class. This class represents the main window of the BitQube UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitQubeGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitQubeGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~BitQubeGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitqube wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
