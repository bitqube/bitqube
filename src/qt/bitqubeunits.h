...
#ifndef BITQUBE_QT_BITQUBEUNITS_H
#define BITQUBE_QT_BITQUBEUNITS_H
...
/** BitQube unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitQubeUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitQubeUnits(QObject *parent);
    ...
    enum Unit
    {
        ...
        mBTQ,
        uBTQ,
        Bit   //!< Smallest BTQ unit: 1 Bit = 0.00000001 BTQ (1 / 100,000,000)
    };
...
typedef BitQubeUnits::Unit BitQubeUnit;

#endif // BITQUBE_QT_BITQUBEUNITS_H
