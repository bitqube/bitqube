...
#ifndef BITQUBE_QT_GUICONSTANTS_H
#define BITQUBE_QT_GUICONSTANTS_H
...
/* BitQubeGUI -- Size of icons in status bar */
...
/* BitQube shadow color - light mode */
...
/* BitQube label color as a string */
...
#define QAPP_ORG_NAME "BitQube"
#define QAPP_ORG_DOMAIN "bitqube.org"
#define QAPP_APP_NAME_DEFAULT "BitQube-Qt"
#define QAPP_APP_NAME_TESTNET "BitQube-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://api.bitqube.org/tx/%s|https://rvn.cryptoscope.io/tx/?txid=%s|https://blockbook.bitqube.org/tx/%s|https://explorer.mangofarmassets.com/tx/%s|https://www.assetsexplorer.com/tx/%s|https://explorer.bitqubeland.org/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // BITQUBE_QT_GUICONSTANTS_H
