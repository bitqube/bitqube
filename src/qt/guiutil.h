...
#ifndef BITQUBE_QT_GUIUTIL_H
#define BITQUBE_QT_GUIUTIL_H
...
/** Utility functions used by the BitQube Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitqube:" URI into recipient object, return true on successful parsing
