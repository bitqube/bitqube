    ...
    mapper(0)
{
    ...
    ui->bitqubeAtStartup->setToolTip(ui->bitqubeAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitqubeAtStartup->setText(ui->bitqubeAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitQubeConfButton->setToolTip(ui->openBitQubeConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitQubeUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitqubeAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitQubeConfButton_clicked()
{
