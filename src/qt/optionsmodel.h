...
#ifndef BITQUBE_QT_OPTIONSMODEL_H
#define BITQUBE_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for BitQube client.
...
#endif // BITQUBE_QT_OPTIONSMODEL_H
