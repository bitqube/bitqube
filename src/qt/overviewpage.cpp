...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(BitQubeUnits::BTQ),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(BitQubeUnits::formatWithUnit(unit, balance, false, BitQubeUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BitQubeUnits::formatWithUnit(unit, unconfirmedBalance, false, BitQubeUnits::separatorAlways));
    ui->labelImmature->setText(BitQubeUnits::formatWithUnit(unit, immatureBalance, false, BitQubeUnits::separatorAlways));
    ui->labelTotal->setText(BitQubeUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, BitQubeUnits::separatorAlways));
    ui->labelWatchAvailable->setText(BitQubeUnits::formatWithUnit(unit, watchOnlyBalance, false, BitQubeUnits::separatorAlways));
    ui->labelWatchPending->setText(BitQubeUnits::formatWithUnit(unit, watchUnconfBalance, false, BitQubeUnits::separatorAlways));
    ui->labelWatchImmature->setText(BitQubeUnits::formatWithUnit(unit, watchImmatureBalance, false, BitQubeUnits::separatorAlways));
    ui->labelWatchTotal->setText(BitQubeUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, BitQubeUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the BTQ balance grid from expanding and looking terrible when asset balance is hidden
