...
#ifndef BITQUBE_QT_RECEIVECOINSDIALOG_H
#define BITQUBE_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of bitqubes */
...
#endif // BITQUBE_QT_RECEIVECOINSDIALOG_H
