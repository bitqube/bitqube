...
#ifndef BITQUBE_QT_SENDASSETSENTRY_H
#define BITQUBE_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending bitqubes.
...
#endif // BITQUBE_QT_SENDASSETSENTRY_H
