...
#include "qt/bitqubeamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BitQubeAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_bitqube-qt -platform xcb      # Linux
//     src/qt/test/test_bitqube-qt -platform windows  # Windows
//     src/qt/test/test_bitqube-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = BitQubeUnits::formatWithUnit(unit, balance, false, BitQubeUnits::separatorAlways);
    ...
    // Amount input
    BitQubeAmountField* amountInput = receiveCoinsDialog.findChild<BitQubeAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: bitqube:")) != -1);
