...
void WalletView::setBitQubeGUI(BitQubeGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? BitQubeGUI::HD44_ENABLED : _walletModel->hdEnabled() ? BitQubeGUI::HD_ENABLED : BitQubeGUI::HD_DISABLED);
