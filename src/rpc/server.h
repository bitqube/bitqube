...
#ifndef BITQUBE_RPCSERVER_H
#define BITQUBE_RPCSERVER_H
...
/**
 * BitQube RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isBTQ = true);
