...
#ifndef BITQUBE_SCRIPT_STANDARD_H
#define BITQUBE_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_BITQUBE_ASSET script that carries data
    /** BTQ END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a bitqube address
 */
...
/**
 * Generate a BitQube scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITQUBE_SCRIPT_STANDARD_H
