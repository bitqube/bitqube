...
#ifndef BITQUBE_TEST_SCRIPTNUM10_H
#define BITQUBE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitQube Core 0.10.0, for cross-comparison.
 */
public:
