 ...
 */
#ifndef BITQUBE_UTIL_H
#define BITQUBE_UTIL_H
...
extern const char *const BITQUBE_CONF_FILENAME;
extern const char *const BITQUBE_PID_FILENAME;
...
{
    std::string s = strprintf("bitqube-%s", name);
