...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitQubeTestFramework
    pass

class ExampleTest(BitQubeTestFramework):
    # Each functional test is a subclass of the BitQubeTestFramework class.
    ...
    def custom_method(self):
        ...
        BitQubeTestFramework class so other tests can use it."""
