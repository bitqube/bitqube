...
class AssetTest(BitQubeTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("BITQUBE1", 1000)
        n0.issue("BITQUBE2", 1000)
        n0.issue("BITQUBE3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="BITQUBE*", verbose=False, count=2, start=-2)
        ...
        bitqube_assets = n0.listassets(asset="BITQUBE*", verbose=False, count=2, start=-2)
        assert_equal(len(bitqube_assets), 2)
        assert_equal(bitqube_assets[0], "BITQUBE2")
        assert_equal(bitqube_assets[1], "BITQUBE3")
        self.sync_all()
