...
class BIP66Test(BitQubeTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitqubed is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitqubed produces more specific reject
            # reasons.
