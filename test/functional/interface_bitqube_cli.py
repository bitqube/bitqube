...
class TestBitQubeCli(BitQubeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `bitqube-cli getinfo`")
        ...
        self.log.info("Compare responses from `bitqube-cli -getinfo` and the RPCs data is retrieved from.")
