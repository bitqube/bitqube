...
import os
import struct
from test_framework.test_framework import BitQubeTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(BitQubeTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitqube has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bitqubed has not been built with zmq enabled.")
