...
By default, bitqubed will dump mempool on shutdown and
...
class MempoolPersistTest(BitQubeTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give bitqubed a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent bitqubed from writing mempool.dat to disk. Verify that `savemempool` fails")
