...
# TestNode: A peer we use to send messages to bitqubed, and store responses.
...
class CompactBlocksTest(BitQubeTestFramework):
    ...
    # This test actually causes bitqubed to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitqubed requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitqubed to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # bitqubed will not send blocktxn responses for blocks whose height is
