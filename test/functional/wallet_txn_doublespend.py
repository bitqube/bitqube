...
class TxnMallTest(BitQubeTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 BTQ:
        ...
        # Node0's balance should be starting balance, plus 50BTQ for another
        ...
        # Node0's total balance should be starting balance, plus 100BTQ for 
